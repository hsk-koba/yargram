...
import {
  ...
  wt,
  xP
} from "./chunk-HMNSPQZX.js";
import {
  require_client
} from "./chunk-ZHCVW5YH.js";
import "./chunk-W4IQ6WTX.js";
import "./chunk-ETL224XV.js";
import "./chunk-265FZ5A2.js";
import {
  require_core_events
...
import {
  z
} from "./chunk-DFJM2W7H.js";
import {
  gt,
  yn
} from "./chunk-W73SRAUG.js";
...
// ../../node_modules/.pnpm/@storybook+addon-docs@8.6.14_@types+react@18.3.27_storybook@8.6.15/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@storybook+blocks@8.6.14_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@8.6.15/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-VUA2EV3I.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-SKIYI6HE.js"));
...
// ../../node_modules/.pnpm/@storybook+react-dom-shim@8.6.14_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@8.6.15/node_modules/@storybook/react-dom-shim/dist/react-18.mjs
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-N3NXVI5I.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-FF74IYPP.js.map
